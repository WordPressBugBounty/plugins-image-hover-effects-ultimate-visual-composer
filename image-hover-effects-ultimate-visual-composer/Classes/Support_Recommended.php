...
class Support_Recommended {
    ...
    public function dismiss_button_scripts() {
        ...
        wp_localize_script(
            'oxi_flip-admin-recommended', 'oxi_flip_admin_recommended', [
				'ajaxurl' => admin_url( 'admin-ajax.php' ),
				'nonce' => wp_create_nonce( 'oxi_flip_admin_recommended' ),
            ]
        );
    }
    ...
    public function __construct() {
        ...
        add_action( 'wp_ajax_oxi_flip_admin_recommended', [ $this, 'notice_dissmiss' ] );
    }
