...
class Widget extends \WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'oxi_flip_box_widget', esc_html__( 'Flipbox - Awesomes Flip Boxes Image Overlay', 'image-hover-effects-ultimate-visual-composer' ), [ 'description' => esc_html__( 'Flipbox - Awesomes Flip Boxes Image Overlay', 'image-hover-effects-ultimate-visual-composer' ) ]
        );
    }
